...
class TestOutput(unittest.TestCase):
    @patch("professional_python_exercises_2_githubcli.common.output.sys.exit")
    @patch("professional_python_exercises_2_githubcli.common.output.typer.echo", autospec=True)
